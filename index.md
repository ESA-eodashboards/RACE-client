...
<section class="light-grey">
  <esa-cards>
    ...
    <esa-card
      title="ESA NoR"
      description="Indicators are output by EO-powered services available through the Network of Resources."
    ...
    <esa-card
      ...
      action="Explore"
      icon="<img src='https://github.com/ESA-eodashboards/RACE-client/blob/main/public/assets/cdse.png?raw=true' height='60' style='max-width: 100%/>"
    ></esa-card>
  </esa-cards>
</section>
