import{b as n,o as s,w as u,j as b,N as c,k as i,c as p,e as d,aB as g,H as w,K as f,F as x,B as v,T as _}from"./framework.D29bnCpw.js";import{y as $,b4 as A}from"./eo-dash.loQ37NQN.js";import{V as k}from"./VMain-DfGy8mMp.BekIiGzq.js";import"./commonjsHelpers.BosuxZz1.js";import"./ssrBoot-Zgc_Ttvi.DwgVpWYr.js";class B extends HTMLElement{static get observedAttributes(){return["column-width","fill-grid","gap","row-height"]}constructor(){super(),this.mediaBreakpoints=[0,600,1280],this.attachShadow({mode:"open"}),this.render()}render(){this.shadowRoot.innerHTML=`
    <style>
      :host {
